...
class AppConfig {
  ...
  static const bool _useProductionOverride = bool.fromEnvironment(
    'USE_PRODUCTION',
    defaultValue: false,
  );
  ...
  static String get websiteUrl =>
      isProduction ? _prodWebsiteUrl : _localWebsiteUrl;
  ...
  static const String _productionApplePayMerchantId =
      'merchant.zouz.tap.production';
  ...
  static String get tapPublishableSandboxKey =>
      AppSecrets.tapSandboxPublishableKey;
  static String get tapPublishableProductionKey =>
      AppSecrets.tapProductionPublishableKey;
